...
export default function FormatsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 sm:py-8 max-w-4xl">
      <h1 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2 animate-fade-in-up">{t("title")}</h1>
      <p className="text-sm sm:text-base text-muted-foreground mb-6 sm:mb-8 animate-fade-in-up" style={{ animationDelay: "50ms" }}>{t("subtitle")}</p>
